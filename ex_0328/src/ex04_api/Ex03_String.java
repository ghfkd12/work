...
public class Ex03_String {
	public static void main(String[] args) {
		...
		// contains()
		// 특정 문자열을 포함하고 있는지 판별 -> true or false
		...
		// startWith()
		// 인자로 전달된 문자열로 시작하는지 확인 -> true,false
		System.out.println(str.startsWith("Kim"));
		
		// endWith()
		// 인자로 전달된 문자열로 끝나는지 확인 -> true, false
